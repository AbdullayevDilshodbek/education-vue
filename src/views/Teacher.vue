<template>
  <v-app class="mt-2">
    ...
    <v-data-table :headers="headers" :items="getTeachers" dense hide-default-footer>
    ...
    <v-dialog v-model="add" fullscreen>
      <PaymentHistory :user_id="user.id" @closeDialog="add = false" @searchByTime="searchByTime"
