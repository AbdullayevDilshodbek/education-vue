<template>
    <v-app>
        ...
        <v-data-table :headers="headers" :items="getSubjects" :item-class="status" dense>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...mapActions('subject', ['fetchSubject', 'addNewSubject', 'updateSubjectData', 'changeSubjectStatus']),
            closeDialog() {
